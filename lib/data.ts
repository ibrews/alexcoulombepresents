  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Cinematics now has a neon alley and an optional three-shot sequence. Lighting has a cabin study with animated sunlight, lantern settings and color grading. Gameplay connects a signal ability to a StateTree courier and a live HUD. Characters compares skeletal animation, a keyed FK Control Rig and two appearances generated by Mutable.",
      },
      {
        heading: "A museum that shows its workings",
        body: "Each of the eight wings now includes an in-world panel showing a real capture of its underlying graph or timeline. Cinematics and Lighting also display actual Movie Render Queue output side by side: a deferred render and a path-traced still of the same room.",
      },
      {
    ...
    screenshots: [
      ...
      },
      {
        ...
        caption:
          "The Cinematics alley after the scene-dressing pass added visible lantern supports and an end gate.",
      },
      {
        src: "/lab/fabel-showcase/r2-03-gameplay-packaged.webp",
        alt: "A mannequin faces a stone courtyard while a courier walks at right and a dark HUD reads Courier StateTree: RUNNING.",
        caption:
          "The packaged Gameplay wing with its courier moving and live StateTree status visible in the HUD.",
      },
      {
        src: "/lab/fabel-showcase/r2-04-mutable-packaged.webp",
...
//
// Titles are Alex's own phrasings, deliberately NOT Epic's course names or
// numbering — same ground covered, our curriculum. Keep it that way.
