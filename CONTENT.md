...
- `[training.40]` ▸ Book a class →
- `[training.41]` ▸ Alex will be in touch to get you booked.
- `[training.42]` ▸ Team / studio training
- `[training.43]` ▸ Alex will be in touch about team training.
