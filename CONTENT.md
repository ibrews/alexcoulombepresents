...
### externalLinks  (9 entries — add or remove whole entries)
...
- `[data.externalLinks.7.label]` ▸ X / Twitter — @alexctraining
- `[data.externalLinks.7.note]` ▸ A separate account, just for Unreal Engine tips — recurring #uetips pulled from the training knowledge base. Not the personal @ibrews feed above.
- `[data.externalLinks.8.label]` ▸ YouTube
- `[data.externalLinks.8.note]` ▸ Unreal Engine tutorials, Unity→UE5 migration guides, MetaHuman deep dives.
